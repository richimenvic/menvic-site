  ...
  return (
    <main className="page-hero">
      <div className="wrap">
        ...
        <p className="section-copy">Arquitectura, construcción, reforma, documentación técnica o apoyo profesional.</p>
        <div className="box contact-form-box contact-guidance-box">
          <h2>Datos útiles</h2>
        ...
        <div className="box contact-form-box">
          ...
          <p>menvic.com</p>
          <p><a className="cta-link" href="https://wa.me/59175019441" target="_blank" rel="noopener noreferrer">Consultar proyecto por WhatsApp</a></p>
        </div>
